...
const (
	...
	ProfileRiskCategoryAggresive    ProfileRiskCategory = "Aggressive"
)
...
var RiskMapping = []ProfileRisk{
	{
		...
		Definition: "Tujuan utama Anda adalah untuk melindungi modal/dana yang ditempatkan dan Anda tidak memiliki toleransi sama sekali terhadap perubahan harga/nilai dari dana investasinya tersebut. Anda memiliki pengalaman yang sangat terbatas atau tidak memiliki pengalaman sama sekali mengenai produk investasi.",
	},
	{
		MinScore:   12,
		MaxScore:   19,
	...
	},
	{
		...
		Definition: "Anda memiliki toleransi yang cukup terhadap produk investasi dan dapat menerima perubahan yang besar dari harga/nilai portfolio tersebut.",
	},
	{
		MinScore:   29,
		MaxScore:   35,
		Category:   ProfileRiskCategoryGrowth,
		Definition: "Anda memiliki toleransi yang cukup tinggi dan dapat menerima perubahan yang besar dari harga/nilai portfolio pada produk investasi yang diinvestasikan. Pada umumnya Anda sudah pernah atau berpengalaman dalam berinvestasi di produk investasi.",
	},
	{
		MinScore:   36,
		MaxScore:   40,
		Category:   ProfileRiskCategoryAggresive,
		Definition: "Anda sangat berpengalaman terhadap produk investasi dan memiliki toleransi yang sangat tinggi atas produk-produk investasi. Anda bahkan dapat menerima perubahan signifikan pada modal/nilai investasi. Pada umumnya portfolio Anda sebagian besar dialokasikan pada produk investasi.",
	},
}
